...
export async function publishMessageCore(
	...
	await ui.withProgress(
		...
		async (_, token) => {
			outputChannel.appendLine(
				localize(
					"commands.publishMessage.publishMessage",
...
export async function publishAllMessage(
	context: IActionContext,
	daprApplicationProvider: DaprApplicationProvider,
	daprClient: DaprClient,
	outputChannel: vscode.OutputChannel,
	...
	return await publishMessageCore(
		context,
		daprApplicationProvider,
		daprClient,
		outputChannel,
...
export const createPublishAllMessageCommand =
	(
		daprApplicationProvider: DaprApplicationProvider,
		daprClient: DaprClient,
		outputChannel: vscode.OutputChannel,
