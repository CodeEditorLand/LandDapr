...
export async function scaffoldRedisComponent(
	...
	await scaffolder.scaffoldFile(
		...
		() =>
			templateScaffolder.scaffoldTemplate(name, {
				redisHost:
					redisHost ??
...
export function scaffoldPubSubComponent(
	scaffolder: Scaffolder,
	templateScaffolder: TemplateScaffolder,
	folderPath: string,
	onConflict: ConflictHandler,
...
export function scaffoldStateStoreComponent(
	scaffolder: Scaffolder,
	templateScaffolder: TemplateScaffolder,
	folderPath: string,
	onConflict: ConflictHandler,
...
export async function scaffoldZipkinComponent(
	scaffolder: Scaffolder,
	templateScaffolder: TemplateScaffolder,
	folderPath: string,
	onConflict: ConflictHandler,
	...
	await scaffolder.scaffoldFile(
		...
		() =>
			templateScaffolder.scaffoldTemplate("components/zipkin.yaml", {
				zipkinHost:
					zipkinHost ??
