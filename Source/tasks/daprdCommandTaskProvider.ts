						...
						const command = CommandLineBuilder.create(
							...
							.withNamedArg(
								...
								daprDefinition.placementHostAddress ??
									`${process.env.DAPR_PLACEMENT_HOST_ADDRESS ?? "localhost"}:${environmentProvider.isWindows ? 6050 : 50005}` /* NOTE: The placement address is actually required for daprd. */,
							)
							.withNamedArg(
								"--profile-port",
